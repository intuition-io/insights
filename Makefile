...
package:
	# NOTE Replace the version in insights.__init__.py ?
	@echo "[make] Committing changes"
	git add -A
	git commit
	git tag ${VERSION}
	git push --tags
	@echo "[make] Packaging insights"
...
tests: warn_missing_linters
	...
	pep8 --exclude _review --ignore E265 tests insights
	@echo -e '\tRunning tests ...'
	nosetests -s -w tests --with-yanc --with-coverage --cover-package=insights
